...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--display_freq', type=int, default=25, help='frequency of showing training results on screen')
        ...
        self.parser.add_argument('--save_display_freq', type=int, default=50, help='save the current display of results every save_display_freq_iterations')
